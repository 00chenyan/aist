...
To address the above problems, this paper proposes AIST to (1) expand high-level, one‑sentence requirements into more comprehensive change descriptions, and (2) provide explainable descriptions of system behavior changes caused by code modifications, thereby making the impact of development changes transparent [15]. For testers, this further clarifies “what to test” and “why to test,” ultimately enabling them to adopt more effective and requirement‑aligned testing strategies [16–17].
